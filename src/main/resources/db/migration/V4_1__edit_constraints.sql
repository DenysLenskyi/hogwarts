...
ALTER TABLE hogwarts.lesson
    DROP CONSTRAINT START_END_TIME_ID_FK;
ALTER TABLE hogwarts.lesson
    ADD CONSTRAINT START_END_TIME_ID_FK FOREIGN KEY (START_END_TIME_ID) REFERENCES HOGWARTS.LESSON_START_END_TIME (ID) ON DELETE SET NULL;
